...
import com.ln.antivirus.mobilesecurity.activities.AppLockCreatePasswordActivity;
import com.ln.antivirus.mobilesecurity.activities.MainActivity;
import com.ln.antivirus.mobilesecurity.iface.ActivityStartingListener;
import com.ln.antivirus.mobilesecurity.iface.IPackageChangesListener;
...
import com.ln.antivirus.mobilesecurity.model.PackageData;
import com.ln.antivirus.mobilesecurity.model.PermissionData;
import com.ln.antivirus.mobilesecurity.model.Scanner;
import com.ln.antivirus.mobilesecurity.model.UserWhiteList;
import com.ln.antivirus.mobilesecurity.receiver.PackageBroadcastReceiver;
import com.ln.antivirus.mobilesecurity.util.ActivityStartingHandler;
    ...
    private class LockAppTask extends TimerTask {
        ...
        public void run() {
            if (VERSION.SDK_INT >= 22) {
                ...
                @SuppressLint("WrongConstant") UsageStatsManager mUsageStatsManager = (UsageStatsManager) MonitorShieldService.this.getSystemService("usagestats");
